          ...
          <div className="flex justify-between h-16 items-center gap-3">
            ...
            <div className="hidden md:flex items-center gap-1 rounded-2xl border border-[var(--surface-border)] bg-white/55 p-1 shadow-sm dark:bg-slate-950/35">
              ...
              <button
                ...
                className="ms-2 flex min-h-10 items-center gap-2 rounded-xl border border-[var(--surface-border)] bg-[var(--surface-card-strong)] px-3 py-1.5 shadow-sm transition-all hover:border-lab-teal/40 hover:bg-lab-teal/5 dark:hover:bg-lab-teal/10 group"
              ...
              <button
                onClick={toggleTheme}
                className="ms-1 flex min-h-10 items-center gap-2 rounded-xl border border-[var(--surface-border)] bg-[var(--surface-card-strong)] px-3 py-1.5 shadow-sm transition-all hover:border-lab-teal/40 hover:bg-lab-teal/5 dark:hover:bg-lab-teal/10 group"
            ...
            <div className="flex md:hidden items-center gap-1.5">
              <button
                onClick={() => setLanguage(language === "en" ? "ar" : "en")}
                className="p-2.5 rounded-xl border border-[var(--surface-border)] bg-[var(--surface-card)] hover:bg-lab-teal/10 transition-colors"
                aria-label="Switch language"
              >
