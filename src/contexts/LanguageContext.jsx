...
const translations = {
  en: {
    ...
    chatbot_input_placeholder: "Ask 3loomangy...",
    chatbot_loading: "Just a moment... 3loomangy is searching the database 🧪",
    chatbot_welcome: "Hey there! 👋 Welcome to 3loomangy! 🎉",
  ...
  ar: {
    ...
    chatbot_input_placeholder: "اسأل علومنجي...",
    chatbot_loading: "ثواني... علومنجي بيدوّر في الدليل 🧪",
    chatbot_welcome: "ازيك! 👋 نورت علومنجي 🎉",
